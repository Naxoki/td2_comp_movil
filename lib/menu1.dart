    ...
    return BasePage(
      ...
      body: ListView(
        children: [
          ...
          Container(
            color: Colors.grey[200], // Color de fondo para la barra (puedes personalizarlo)
          ...
          NewsCard(
            ...
            description: 'Esta es la descripción de la noticia, que se muestra arriba de la imagen.',
